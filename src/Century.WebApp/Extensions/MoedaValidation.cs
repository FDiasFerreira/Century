...
{
    public class MoedaValidation : ValidationAttribute
    {
    ...
    public class MoedaAttributeAdapter : AttributeAdapterBase<MoedaValidation>
    {

        public MoedaAttributeAdapter(MoedaValidation attribute, IStringLocalizer stringLocalizer) : base(attribute, stringLocalizer)
        {
    ...
    public class MoedaValidationAttributeAdapterProvider : IValidationAttributeAdapterProvider
    {
        ...
        {
            if (attribute is MoedaValidation moedaAttribute)
            {
